 ...
 * <ul>
 *   <li>{@link org.eclipse.uml2._1._0._0.uml.impl.SubstitutionImpl#getGroup9 <em>Group9</em>}</li>
 *   <li>{@link org.eclipse.uml2._1._0._0.uml.impl.SubstitutionImpl#getContract <em>Contract</em>}</li>
 *   <li>{@link org.eclipse.uml2._1._0._0.uml.impl.SubstitutionImpl#getContract1 <em>Contract1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SubstitutionImpl extends RealizationImpl implements Substitution
{
	...
	public FeatureMap getGroup9()
	{
		if (group9 == null)
		{
			group9 = new BasicFeatureMap(this, UmlPackage.SUBSTITUTION__GROUP9);
		}
		return group9;
	}
	 ...
	 * @generated
	 */
	public EList<Classifier> getContract()
	{
		return getGroup9().list(UmlPackage.eINSTANCE.getSubstitution_Contract());
	}
	...
	public void setContract1(String newContract1)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.SUBSTITUTION__CONTRACT1, oldContract1, contract1));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case UmlPackage.SUBSTITUTION__GROUP9:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case UmlPackage.SUBSTITUTION__CONTRACT:
				return getContract();
			case UmlPackage.SUBSTITUTION__CONTRACT1:
				return getContract1();
		}
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			...
			case UmlPackage.SUBSTITUTION__CONTRACT:
				getContract().clear();
				getContract().addAll((Collection<? extends Classifier>)newValue);
				return;
			case UmlPackage.SUBSTITUTION__CONTRACT1:
