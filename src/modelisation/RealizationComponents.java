...
/**
 * Fichier : RealizationComponents.java
 *
...
/**A representation of an arrow that represents the implementation link*/
public class RealizationComponents extends LineComponents 
{
	 ...
	 */
	public RealizationComponents (int xbegin, int xend, int ybegin, int yend, int nHeadType)
	{
	...
	public void paint(Graphics g)
	{
	    ...
	    if (getHeadType() == 1)
	    {
	    	 ...
	    	 g2D.drawLine(super.getXend()+MARGIN,super.getYend()+MARGIN,super.getXend(),super.getYend());
	    	 g2D.drawLine(super.getXend()-MARGIN, super.getYend()+MARGIN, super.getXend()+MARGIN, super.getYend()+MARGIN);
	    }
