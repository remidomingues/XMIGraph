...
/**
 * Fichier : uniComposition.java
 *
 * Créé le 14 mars 2012 à 13:57:33
 *
...
/**
 */
public class UniComposition extends LineComponents
{
	...
	/**
	 * fulfilled constructor for an UniComposition
	 ...
	 */
	public UniComposition(int xbegin, int xend, int ybegin, int yend,String nText, String rightc, String leftc, String leftR, String rightR, int nHead) 
	{
	 ...
	 * @param nHead the orientation of the association
	 */
	public UniComposition(int xbegin, int xend, int ybegin, int yend,String nText, String rightc, String leftc, int nHead) 
	{
...
/*_______________________________________________________*/
/* Fin du ficher uniComposition.java
/*_______________________________________________________*/