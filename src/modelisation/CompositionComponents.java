...
/**
 * Fichier : CompositionComponents.java
 *
...
/**This class is a graphic interpretation of a composition link between two classes*/
public class CompositionComponents extends LineComponents
{
	/** Generated serial version ID */
	private static final long serialVersionUID = 6661286026533602596L;
	...
	/**
	 * fulfilled constructor for an CompositionComponents
	 ...
	 * @param leftR the right role
	 * @param rightR the right role
	 * @param nHead the orientation of the association
	 */
	public CompositionComponents(int xbegin, int xend, int ybegin, int yend,String nText, String rightc, String leftc, String leftR, String rightR, int nHead) 
	{
	 ...
	 * @param nHead the orientation of the association
	 */
	public CompositionComponents(int xbegin, int xend, int ybegin, int yend,String nText, String rightc, String leftc, int nHead) 
	{
